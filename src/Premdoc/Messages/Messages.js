...
import people from '../../assets/images/user-avatar-small-01.jpg';
import girl from '../../assets/images/user-avatar-small-02.jpg';
import empty from '../../assets/images/user-avatar-placeholder.png'
      ...
      <div className="messages-container-inner">
        ...
        <div className="messages-inbox">
          <div className="messages-headline">
            <div className="input-with-icon search-text">
              <input id="autocomplete-input" type="text" placeholder="Search"  />
              <i className="icon-material-outline-search" ><IoMdSearch /></i>
            </div>
          </div>
          <ul>
            <li>
              <a href="#">
                <div className="message-avatar"><i className="status-icon status-online" /> <img src={people} alt="pic" /></div>
            ...
            <li className="active-message">
              <a href="#">
                <div className="message-avatar"><i className="status-icon status-offline" /><img src={girl} alt="pic" /></div>
                <div className="message-by">
                  <div className="message-by-headline">
                    <h5>Sindy Forest</h5>
                    <span>Yesterday</span>
            ...
            <li>
              <a href="#">
                <div className="message-avatar"><i className="status-icon status-offline" /><img src={empty} alt="pic" /></div>
                <div className="message-by">
                  <div className="message-by-headline">
            ...
            <li>
              <a href="#">
                <div className="message-avatar"><i className="status-icon status-online" /><img src={empty} alt="pic" /></div>
                <div className="message-by">
                  <div className="message-by-headline">
        ...
        <div className="message-content">
          <div className="messages-headline">
            <h4>Sindy Forest</h4>
            <a href="#" className="message-action"><i className="icon-feather-trash-2" ><RiDeleteBinLine /></i> Delete Conversation</a>
          </div>
          ...
          <div className="message-content-inner">
            ...
            <div className="message-bubble me">
              <div className="message-bubble-inner">
                <div className="message-avatar"><img src={people} alt="pic" /></div>
            ...
            <div className="message-bubble">
              <div className="message-bubble-inner">
                <div className="message-avatar"><img src={girl} alt="girl" /></div>
            ...
            <div className="message-bubble">
              <div className="message-bubble-inner">
                <div className="message-avatar"><img src={girl} alt="pic" /></div>
